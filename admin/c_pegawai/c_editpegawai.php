<?php
 ...
 $query = "UPDATE tb_pegawai SET nip_npak='$nip_npak',username='$username',password='$password',
...
$result = mysqli_query($koneksi, $query);
    if(!$result){
      ...
      echo "<script>alert('Ubah Data Berhasil.');window.location='data_pegawai.php';</script>";
    }
  }
