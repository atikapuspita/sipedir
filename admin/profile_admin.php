<?php
    ...
    include "c_profile/c_editadmin.php";
    include "c_profile/c_editpassword.php";
...
<div class="wrapper">
    ...
    <section class="content">
              ...
              <div class="col-12 col-md-8">
                  <div class="card card-secondary">
                      <div class="card-header">
                          <h3 class="card-title">Data <?php echo $tik['username']; ?></h3>
                      </div> 
                      ...
                      <div class="card-body box-profile">
                          ...
                          <li class="list-group-item">
                              ...
                              <li class="list-group-item">
                                  <b>Tanda Tangan</b> <a class="float-right text-secondary"><td><img src="img/ttd_pegawai/<?php echo $tik['ttd_pegawai'];?>" alt="Foto" width="150"</td></a>
                              </li>
                          </ul>
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <div class="form-group" >
                  ...
                  <input name = "nip_npak" type="text" class="form-control" value="<?php echo $bio['nip_npak']; ?>" oninput="this.value = this.value.replace(/[^0-9]/g, '').replace(/(\..*)\./g, '$1');">
              </div>
                  ...
                  <div class="form-group">
                        ...
                        <div class="input-group">
                          <div class="custom-file">
                            ...
                            <input type="file" name = "foto_pegawai" id="foto_pegawai" class="form-control" accept="image/x-png,image/gif,image/jpeg"/>
                          </div>
                        </div>
                    ...
                    <img src="img/ttd_pegawai/<?php echo $bio['ttd_pegawai'];?>"alt="ttd" width="80" ><br><br>
                      <div class="input-group">
                        <div class="custom-file">
                          ...
                          <input type="file" name = "ttd_pegawai" id="ttd_pegawai" class="form-control" accept="image/x-png,image/gif,image/jpeg"/>
                        </div>
                      </div>
                      <i style="float: left;font-size: 14px;color: red">Tipe file JPEG/JPG/PNG dengan batas max 5 mb</i> <br>
                      </div>
      ...
      <?php $no = 0;
      foreach ($user as $row) : $no++; ?>
      <div class="modal fade" id="ubahpassword<?php echo $tik['nip_npak']; ?>" role="dialog">
        <div class="modal-dialog">
        <div class="modal-dialog">
          <div class="modal-content">
            <div class="modal-header">
            ...
            <div class="modal-body">
              ...
              <input type="hidden" name="id_pegawai" value="<?php echo $tik['id_pegawai']; ?>">
              

              <div class="form-group">
                  <label>Password Lama</label><span class="text-red">*</span></label>
                  <input type="password" class="form-control" name="passwordLama" placeholder="Password" id="myPassword" value="<?php echo $tik['password']; ?>">
