...
<div class="wrapper">
  ...
  <?php
      ...
      $doswal = mysqli_query($koneksi, "SELECT id_kajur,id_jurusan FROM tb_kajur WHERE id_pegawai = '$id_pegawai'");
      $hasil = mysqli_fetch_array($doswal);
      $id_jurusan = $hasil["id_jurusan"];
      $id_kajur = $hasil["id_kajur"];
      
      $user = mysqli_query($koneksi, "SELECT * FROM tb_pengajuan INNER JOIN tb_mahasiswa ON tb_pengajuan.id_mahasiswa = tb_mahasiswa.id_mahasiswa join tb_kelas on tb_mahasiswa.id_kelas=tb_kelas.id_kelas join tb_prodi on tb_prodi.id_prodi=tb_kelas.id_prodi WHERE status_pengajuan = '3' AND tb_prodi.id_jurusan = '$id_jurusan' order by tb_pengajuan.tgl_pengajuan desc;");
                            ...
                            <div class="row text-center d-flex justify-content-center">
                              <div class="col">
                                <form action="" method="post">
                                  ...
                                  <input type="hidden" name="id_kajur" value="<?= $id_kajur; ?>">
