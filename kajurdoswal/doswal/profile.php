...
<?php
 ...
 $user = mysqli_query($koneksi, "SELECT * FROM tb_doswal join tb_pegawai on tb_pegawai.id_pegawai=tb_doswal.id_pegawai join tb_kelas on tb_kelas.id_kelas=tb_doswal.id_kelas WHERE tb_doswal.id_pegawai = '$id_pegawai'");
                ...
                <div class="card card-secondary">
                    ...
                    <div class="card-body box-profile">
                        <ul class="list-group list-group-unbordered mb-3">
                            ...
                            <li class="list-group-item">
                                <b>Dosen Wali Kelas</b> <a class="float-right text-secondary"><td><?php echo $tik['nama_kelas']; ?></td></a>
                            </li>
                            <li class="list-group-item">
                        ...
                        <a data-toggle ="modal" data-target="#myModal<?php echo $tik['id_doswal']; ?>" class="btn btn-secondary"><b>Ubah Profile</b></a>
                    </div>
                </div>
            </div>
          </div> 
