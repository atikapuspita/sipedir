...
<div class="wrapper">
  ...
  <?php
      ...
      // ambil data doswal dari session id pegawai
      ...
      // cek data hasil ada isinya atau tidak, jika ada ambil data id kelas dari fecth hasil jika tidak maka set ke ''
      $id_kelas = empty($hasil["id_kelas"]) ? "" : $hasil["id_kelas"];
      // cek data hasil ada isinya atau tidak, jika ada ambil data id doswal dari fecth hasil jika tidak maka set ke ''
                                      ...
                                      <div class="modal-dialog modal-s">
                                          <div class="modal-content">
                                              ...
                                              <div class="modal-footer justify-content-between">
                                                  ...
                                                  <button type="submit" class="btn btn-outline-danger btn-sm" name="Ditolak" value="Ditolak"  onclick="return confirm('Anda yakin menolak pengajuan ini?')">
                                                    <i class = "fas fa-times-circle"></i> Tolak</button>
                                              </div>
                                                </form>
                                          </div>
