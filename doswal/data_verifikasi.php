...
<div class="wrapper">
  ...
  <?php
      ...
      $user = mysqli_query($koneksi, "SELECT tb_pengajuan.*, tb_verifikasi_doswal.status_pengajuan , tb_mahasiswa.* FROM tb_verifikasi_doswal INNER JOIN tb_pengajuan on tb_pengajuan.id_pengajuan=tb_verifikasi_doswal.id_pengajuan INNER JOIN tb_mahasiswa ON tb_pengajuan.id_mahasiswa = tb_mahasiswa.id_mahasiswa inner join tb_doswal on tb_doswal.id_doswal=tb_verifikasi_doswal.id_doswal WHERE tb_verifikasi_doswal.status_pengajuan = '1' AND tb_doswal.id_pegawai='$id_pegawai' OR tb_verifikasi_doswal.status_pengajuan = '5' AND tb_doswal.id_pegawai='$id_pegawai' order by tb_pengajuan.tgl_pengajuan desc;");
