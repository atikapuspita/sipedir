    ...
    <center>
        <table width="700">
            ...
            <table>
                ...
                <tr>
					<td width="400"><center>
                    <img src="../admin/img/ttd_orangtua/<?php echo $data['ttd_ortu'];?>"width="50px" height="50px">
                        <br>
                        <?php echo $data['nama_ortu']; ?></center>
                    </td>
                    <td width="300"><center>
                        <img src="../admin/img/ttd_mahasiswa/<?php echo $data['ttd_mhs'];?>"width="50px" height="50px">
                        <br>
             ...
             <table>
                <tr>
                    ...
                    <td width="300"><center>Wali Dosen</center><br></td>
                </tr>
                <tr>
					<td width="400"></td>
                    <td width="300"></td>
                ...
                <tr>
					<td width="400"><center>
                    <img src="../admin/img/ttd_pegawai/<?php echo $p['ttd_pegawai'];?>"width="50px" height="50px">
                        <br>
                    <?php echo $j['nama_pegawai']; ?><br>
                        NIDN. <?php echo $j['nip_npak']; ?></center>
                    </td>
                    <td width="300"><center>
                    <img src="../admin/img/ttd_pegawai/<?php echo $s['ttd_pegawai'];?>"width="50px" height="50px">
                        <br>
                    <?php echo $s['nama_pegawai']; ?><br>
                        NIDN. <?php echo $s['nip_npak']; ?></center>
                    </td>
                </tr>
                <tr>
                    <td><br></td>
