<?php
  ...
  $query = "UPDATE tb_pegawai SET nama_pegawai='$nama_pegawai',username='$username_doswal',
            no_telp_pegawai='$no_telp_pegawai',ttd_pegawai='$ttd_pegawai',foto_pegawai='$foto_pegawai' WHERE id_pegawai='$id_pegawai'";
