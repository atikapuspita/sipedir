<?php
    ...
    session_start();
    include "c_profil/c_editprofile_doswal.php";
...
<?php
 ...
 $user = mysqli_query($koneksi, "SELECT * FROM tb_kajur join tb_pegawai on tb_pegawai.id_pegawai=tb_kajur.id_pegawai join tb_jurusan on tb_jurusan.id_jurusan=tb_kajur.id_jurusan WHERE tb_kajur.id_pegawai = '$id_pegawai'");
            ...
            <div class="col-12 col-md-8">
                <div class="card card-secondary">
                    ...
                    <div class="card-body box-profile">
                        ...
                        <a data-toggle ="modal" data-target="#editpw<?php echo $tik['id_kajur']; ?>" class="btn btn-secondary"><b>Ubah Password</b></a>
                        <a data-toggle ="modal" data-target="#myModal<?php echo $tik['id_kajur']; ?>" class="btn btn-secondary"><b>Ubah Profile</b></a>
                    </div>
                </div>
            </div>
          </div> 
...
<?php $no = 0;
 ?>
  <div class="modal fade" id="myModal<?php echo $tik['id_kajur']; ?>" role="dialog">
        ...
        <div class="modal-content">
          ...
          <form role="form" action="" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group">
              ...
              <input name = "nama_pegawai" type="text" class="form-control" value="<?php echo $tik['nama_pegawai']; ?>" >
            </div>
 
            <div class="form-group">
              <label>Username</label>
              <input name = "username_doswal" type="text" class="form-control" value="<?php echo $tik['username']; ?>">
            </div>

            <div class="form-group">
              <label>No Telp</label>
              <input name = "no_telp_pegawai" type="text" class="form-control" value="<?php echo $tik['no_telp_pegawai']; ?>">
            </div>
            <div class="form-group">
                <label>Foto Pegawai</label>
                <div class="input-group">
                  <div class="custom-file">
                    <input type="hidden" name = "foto_pegawai" class="form-control" value="<?php echo $tik['foto_pegawai']; ?>" >
              ...
              <div class="form-group">
                <label>Tanda Tangan</label>
                  <div class="input-group">
                    <div class="custom-file">
                      <input type="hidden" name = "ttd_pegawai" class="form-control" value="<?php echo $tik['ttd_pegawai']; ?>" >
...
<?php $no = 0;
 $no++; ?>
  <div class="modal fade" id="editpw<?php echo $tik['id_kajur']; ?>" role="dialog">
    <div class="modal-dialog">
      <div class="modal-dialog">
        <div class="modal-content">
          <div class="modal-header">
          ...
          <form role="form" action="" method="post">
            <div class="modal-body">
              ...
              <div class="form-group">
                  ...
                  <input type="password" class="form-control" name="passwordLama" placeholder="Password" id="myPasswords" value="<?php echo $tik['password']; ?>">
...
<script>
  function myFunction() {
  var x = document.getElementById("myPasswords");
    if (x.type === "password") {
      x.type = "text";
    } else {
    x.type = "password";
