...
<?php
    $data_pengajuan = mysqli_query($koneksi, "SELECT * FROM tb_pengajuan WHERE status_pengajuan='4'");
    $jumlah_pengajuan = mysqli_num_rows($data_pengajuan);
?>

<?php
    // $data_verifikasi = mysqli_query($koneksi, "SELECT * FROM tb_verifikasi WHERE status_pengajuan = '3'");
