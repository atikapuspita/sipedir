<?php
    ...
    include "c_profil/c_editprofile.php";
...
<div class="wrapper">
    <?php include "header_wadir.php"; ?>
    <?php include "sidebar_wadir.php"; ?>
    ...
    <section class="content">
                ...
                <div class="card card-secondary">
                    ...
                    <div class="card card-secondary card-outline">
                        <div class="card-body box-profile">
                            ...
                            <a data-toggle ="modal" data-target="#myModal<?php echo $tik['nip_npak']; ?>" class="btn btn-secondary"><b>Edit Profil</b></a>
                          </div>
                        <!-- /.card-body -->
                    </div>
                </div>
      ...
      <div class="modal fade" id="ubahpassword<?php echo $row['nip_npak']; ?>" role="dialog">
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            <div class="modal-header">
              <h4 class="modal-title">Edit Password Pegawai</h4>
              <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true">&times;</span>
              </button>
            </div>
