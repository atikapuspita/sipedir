...
<div class="wrapper">
  ...
  <?php
      include "header_wadir.php";
      include "sidebar_wadir.php";
      ...
      $user = mysqli_query($koneksi, "SELECT * FROM tb_mahasiswa INNER JOIN tb_pengajuan ON tb_pengajuan.id_mahasiswa = tb_mahasiswa.id_mahasiswa 
                          INNER JOIN tb_kelas ON tb_mahasiswa.id_kelas = tb_kelas.id_kelas INNER JOIN tb_prodi on tb_kelas.id_prodi = tb_prodi.id_prodi INNER JOIN tb_jurusan on tb_jurusan.id_jurusan=tb_prodi.id_jurusan WHERE status_pengajuan = '4' order by tb_pengajuan.tgl_pengajuan desc");
  ?>
        ...
        <div class="row">
          <div class="col-12">
            <div class="card">
              ...
              <a class="no-print btn btn-sm btn-primary" href="../admin/cetak.php" target="_blank"><i class="fas fa-print"></i>  Cetak Laporan</a>
            </div>
              <!-- /.card-header -->
