...
<div class="wrapper">
  ...
  <?php
      ...
      $user = mysqli_query($koneksi, "SELECT * FROM tb_pengajuan INNER JOIN tb_mahasiswa ON tb_pengajuan.id_mahasiswa = tb_mahasiswa.id_mahasiswa WHERE tb_pengajuan.status_pengajuan = '1' order by tb_pengajuan.tgl_pengajuan desc;");
     
      $jabatan = mysqli_query($koneksi, "SELECT * FROM tb_pegawai inner join tb_unit_kerja on tb_unit_kerja.id_pegawai=tb_pegawai.id_pegawai   WHERE tb_pegawai.id_pegawai = '$id_pegawai'");
    //  if($jabatan!=null){
