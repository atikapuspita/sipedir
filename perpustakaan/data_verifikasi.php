...
<div class="wrapper">
  ...
  <?php
      include "header_perpustakaan.php";
      include "sidebar_perpustakaan.php";
      
      $user = mysqli_query($koneksi, "SELECT tb_pengajuan.*, tb_verifikasi_unit.status_pengajuan , tb_mahasiswa.* FROM tb_verifikasi_unit INNER JOIN tb_pengajuan on tb_pengajuan.id_pengajuan=tb_verifikasi_unit.id_pengajuan INNER JOIN tb_mahasiswa ON tb_pengajuan.id_mahasiswa = tb_mahasiswa.id_mahasiswa inner join tb_unit_kerja on tb_unit_kerja.id_unit=tb_verifikasi_unit.id_unit WHERE tb_verifikasi_unit.status_pengajuan = '2' AND tb_unit_kerja.id_pegawai='$id_pegawai' OR tb_verifikasi_unit.status_pengajuan = '5' AND tb_unit_kerja.id_pegawai='$id_pegawai' order by tb_pengajuan.tgl_pengajuan desc;");
